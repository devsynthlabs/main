...
const ProfitLoss = () => {
  ...
  const downloadPDF = () => {
    ...
    if (!statement) {
      ...
      doc.setFontSize(16);
      doc.text("PROFIT & LOSS STATEMENT REPORT", pageW / 2, 20, { align: "center" });

      doc.setFont("helvetica", "normal");
      doc.setFontSize(11);
      doc.setTextColor(100, 116, 139);
      doc.text("No profit and loss data available for the selected period.", pageW / 2, 50, { align: "center" });
    ...
    const revenueRows = [
      ["1", "Sales", formatPDFCurrency(statement.sales, "Rs. ")],
      ["2", "Service Income", formatPDFCurrency(statement.serviceIncome, "Rs. ")],
      ["3", "Interest Income", formatPDFCurrency(statement.interestIncome, "Rs. ")],
      ["4", "Other Income", formatPDFCurrency(statement.otherIncome, "Rs. ")]
    ];
    ...
    autoTable(doc, {
      ...
      foot: [["", "Total Revenue", formatPDFCurrency(statement.totalRevenue, "Rs. ")]],
    ...
    const expenseRows = [
      ["1", "Cost of Materials", formatPDFCurrency(statement.costOfMaterials, "Rs. ")],
      ["2", "Salaries", formatPDFCurrency(statement.salaries, "Rs. ")],
      ["3", "Rent", formatPDFCurrency(statement.rent, "Rs. ")],
      ["4", "Utilities", formatPDFCurrency(statement.utilities, "Rs. ")],
      ["5", "Finance Cost", formatPDFCurrency(statement.financeCost, "Rs. ")],
      ["6", "Depreciation", formatPDFCurrency(statement.depreciation, "Rs. ")],
      ["7", "Amortization", formatPDFCurrency(statement.amortization, "Rs. ")],
      ["8", "Other Expenses", formatPDFCurrency(statement.otherExpenses, "Rs. ")]
    ];
    ...
    autoTable(doc, {
      ...
      margin: { left: margin, right: margin },
      foot: [["", "Total Expenses", formatPDFCurrency(statement.totalExpenses, "Rs. ")]],
    ...
    doc.text(`${formatPDFCurrency(statement.netProfit, "Rs. ")}  (${formatPDFRatio(statement.profitMargin, "%")})`, margin + contentW - 5, y + 8, { align: "right" });
    y += 18;
